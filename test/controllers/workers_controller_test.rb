...
class WorkersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create worker" do
    assert_difference("Worker.count") do
      post workers_url, params: { worker: { group_id: @worker.group_id, name: @worker.name } }
    end
  ...
  test "should update worker" do
    patch worker_url(@worker), params: { worker: { group_id: @worker.group_id, name: @worker.name } }
